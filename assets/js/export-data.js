	...
	k(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function (a) {
		...
		a = a.downloadURL = function (a, l) {
			...
			if ("string" === typeof a || a instanceof String || !m.msSaveOrOpenBlob) {
				...
				if ("undefined" !== typeof b.download)
					(b.href = a),
						(b.download = l),
		...
		function (a, f, d, p, l, r, m) {
			function k(a, n) {
				...
				try {
					...
					if (!b)
						return d.createObjectURL(new g.Blob(["\ufeff" + a], { type: n }));
				} catch (N) {}
			}
			var I = p.doc,
				b = p.seriesTypes,
			...
			f.prototype.setUpKeyToAxis = function () {
				b.arearange &&
					(b.arearange.prototype.keyToAxis = { low: "y", high: "y" });
				b.gantt && (b.gantt.prototype.keyToAxis = { start: "x", end: "x" });
			};
			f.prototype.getDataRows = function (c) {
				...
				var l = g.categoryHeader,
					...
					H = function (a, c, e) {
						...
						c.forEach(function (c) {
							var b = ((a.keyToAxis && a.keyToAxis[c]) || c) + "Axis";
					...
					if (
						...
						for (l = 0; l < f; )
							(z = w(a, q[l], q.length)),
								...
								c && m.push(z.topLevelColumnTitle || z),
								l++;
						var A = {
							chart: a.chart,
						...
						a.options.data.forEach(function (c, d) {
							n && (B = H(a, q, d));
							var w = { series: A };
							a.pointClass.prototype.applyOptions.apply(w, [c]);
							c = w.x;
							var h = a.data[d] && a.data[d].name;
							l = 0;
							if (!e || "name" === a.exportKey || (!n && e && e.hasNames && h))
								c = h;
							g && (g[c] && (c += "|" + d), (g[c] = !0));
							t[c] || ((t[c] = []), (t[c].xValues = []));
							t[c].x = w.x;
							t[c].name = h;
							for (t[c].xValues[k] = w.x; l < f; )
								(d = q[l]),
									(h = w[d]),
									(t[c][x + l] = v(
										B.categoryMap[d][h],
										B.dateTimeValueAxisMap[d]
											? y.dateFormat(b.dateFormat, h)
											: null,
										h
									)),
									l++;
				...
				for (x = h.length; x--; ) {
					...
					var k = d[A];
					f.sort(function (a, c) {
						return a.xValues[A] - c.xValues[A];
					});
					g = w(k);
					e[0].splice(D, 0, g);
						...
						k &&
							...
							(k.dateTime
								? (a.x instanceof Date && (a.x = a.x.getTime()),
								  (c = y.dateFormat(b.dateFormat, a.x)))
								: (c = k.categories
			...
			f.prototype.getCSV = function (a) {
				...
				d.forEach(function (a, b) {
					for (var n, y = a.length; y--; )
						(n = a[y]),
							"string" === typeof n && (n = '"' + n + '"'),
							"number" === typeof n &&
								"." !== f &&
								(n = n.toString().replace(".", f)),
							(a[y] = n);
					c += a.join(l);
					b < d.length - 1 && (c += g);
				});
			...
			f.prototype.getTableAST = function (a) {
				...
				var g = l ? a.shift() : null,
					...
					m = function (a, c, b, d) {
						...
						"number" === typeof h
							...
							: d || (c = "empty");
						b = F({ class: c }, b);
						return { tagName: a, attributes: b, textContent: h };
					};
						...
						if (c) {
							...
							for (b = c.length; h < b; ++h)
								"undefined" !== typeof c[h] &&
									e.push(m("th", null, { scope: "col" }, c[h]));
							f.push({ tagName: "tr", children: e });
						}
				...
				a.forEach(function (a) {
					for (var b = [], d = 0; d < c; d++)
						b.push(m(d ? "td" : "th", null, d ? {} : { scope: "row" }, a[d]));
			...
			f.prototype.toggleDataTable = function (a) {
				...
				this.dataTableDiv &&
					...
					a &&
						((this.dataTableDiv.innerHTML = d.emptyHTML),
			...
			b.mapbubble && (b.mapbubble.prototype.exportKey = "name");
