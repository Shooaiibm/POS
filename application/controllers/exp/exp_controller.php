...
class exp_controller extends CI_Controller{
public function __construct()
{
parent::__construct();
$this->load->model('Exp/expmodel', 'M');
}
/**
...
$data = $this->M->addItemsprd($this->input->post('Code',TRUE ),$this->input->post('SalePrice',TRUE ),$this->input->post('Discount',TRUE ),
$this->input->post('purchasePrice',TRUE ),
$this->input->post('color',TRUE ),
$this->input->post('Memory',TRUE ),$this->input->post('status',TRUE )
...
$data = $this->M->updtedItemsprd($this->input->post('ID',TRUE ),$this->input->post('Code',TRUE ),$this->input->post('SalePrice',TRUE ),$this->input->post('Discount',TRUE ),
$this->input->post('purchasePrice',TRUE ),
$this->input->post('color',TRUE ),
$this->input->post('Memory',TRUE ),$this->input->post('status',TRUE )
