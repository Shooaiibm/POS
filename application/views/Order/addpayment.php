...
<div class="form-group mb-4">
    <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" for="option1">Pending</label>
    </div>

    <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="scanOption" id="option2"  onclick="loaddata()" value="2">
        <label class="form-check-label" for="option2">Approved</label>
    </div>
    <div class="row p-2">
                       
                       
                       <div class="col-md-3" id="sdatee">
...
let url = "<?php echo base_url("Order/Ordercontroller/loadpayment")?>";

$.post(url, {"deliveryStatus": deliveryStatus,"stardate": stardate,"enddate": enddate}, function(data) {
    let html = `
    ...
    data.forEach(element => {
        totalAmount += parseFloat(element.Amont || 0);
        html += `<tr>
            ...
            <td>
                ${element.PaymentStatus == 1 
                    ? '<button class="btn btn-success btn-sm">Payment Added Successfully</button>' 
                    : `<button class="btn btn-info btn-sm" onclick="sendrequest(${element.OID})">Add Payment</button>`}
            </td>
        </tr>`;
    });
    ...
    html += `</tbody>
        <tfoot>
            <tr>
                <td colspan="10" class="text-end font-weight-bold">Total COD:</td>
...
function sendrequest(id){  
        ...
        swal({
      title: "Are you sure to Add Payment selected record?",
      ...
      if (isConfirm) {
        ...
        let url = "<?php echo base_url("Order/Ordercontroller/Payment")?>";
